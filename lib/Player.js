...
function Player(name='') {
  ...
  /* 
  what's the difference when using prototypes? Which one is preferable? At a glance, using this.methodName probably makes more sense. It clearly shows that you are creating methods for each player. Unfortunately, that's also the problem: it creates new methods for each player. If you have a game that creates 100 Player objects, your code will create a hundred getStats() methods.
